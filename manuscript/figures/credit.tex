...
\documentclass[7pt,margin=1mm]{standalone}
...
\foreach \y [count=\n] in {
    ...
    {\hi,\lo,\lo},  % Conceptualization
    {\hi,\lo,\lo},    % Methodology
    {\hi,0,0},        % Investigation
    {\hi,0,0},        % Data curation
    {\hi,0,0},        % Formal analysis
    {\hi,\lo,\lo},        % Validation
    {\hi,0,0},        % Visualisation
    % {0,0,\mid},     % Resources (none specified)
    {\hi,\mid,\lo},    % Software
    {\hi,0,0},        % Writing---Original Draft
    {\hi,\mid,\mid},  % Writing---Reviewing and Editing
    {0,\lo,\hi},      % Funding acquisition
    {0,\lo,\hi},      % Supervision
} {
    % heatmap tiles
